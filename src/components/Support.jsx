...
import { AiOutlinePhone, AiOutlineArrowRight, AiOutlineGlobal, AiOutlineRadarChart } from 'react-icons/ai';
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <AiOutlinePhone className=' bg-indigo-600 text-white' />
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <AiOutlineGlobal  className=' bg-indigo-700 text-white' />
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <AiOutlineRadarChart className=' bg-indigo-600 text-white' />
